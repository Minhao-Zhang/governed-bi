...
def test_capabilities_reports_the_ported_utkuai_toggles(monkeypatch) -> None:
    ...
    client = TestClient(routes.make_app(session, None, _TurnLog()))
...
def test_capabilities_reports_can_curate_corpus_from_corpus_root(monkeypatch, tmp_path: Path) -> None:
    ...
    session = _tiny_session()
    caps = TestClient(routes.make_app(session, None, _TurnLog())).get("/capabilities").json()
    ...
    with_root = routes.make_app(replace(session, corpus_root=tmp_path), None, _TurnLog())
