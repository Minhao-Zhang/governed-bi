...
- **[Rebuild decisions](plans/rebuild-decisions.md) (Simplified Chinese): the twelve decisions behind that queue — what was chosen, why, and what was rejected. Read this before overturning anything in the checklist.**
